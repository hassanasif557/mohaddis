...
class SubChapterScreen3 extends StatefulWidget {

  final String name;
  const SubChapterScreen3({Key? key, required this.name}) : super(key: key);

  @override
  State<SubChapterScreen3> createState() => _SubChapterScreen3State();
}

class _SubChapterScreen3State extends State<SubChapterScreen3> {
