...
class SearchResultScreen extends StatefulWidget {
  final String text;
  final List<int> defaultTarakeem;
                            ...
                            child: Container(
                              ...
                              child: ListTile(
                                ...
                                onTap: () async {
                                  ...
                                  String? mainbookID = prefs.getString('mainbookID') ?? '1';
                                  String? mainbook = prefs.getString('mainbookName') ?? 'صحیح بخاری';


                                  String tarakeem = widget.defaultTarakeem[1].toString();
                                  String translation = widget.defaultTranslation[1];
                                  String hashiya = widget.defaultHashiya[1];
                                  String hukam = widget.defaultHukam[1];
...
Future<pos> fetchUsers(String text,String mainbookid, String pagenumber, String number) async {
  try {
    print(
        'searchtext= ${text}, mainbook= ${mainbookid}  offset= ${number}');
    Response response =
    await Dio().get('https://api.mohaddis.com/api/SearchAhadith?type=json',
        queryParameters: {
          'SearchText': text,
          'IsUrdu': 'true',
          'IsEnglish': 'false',
