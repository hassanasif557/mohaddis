...
class Tarakeem extends StatefulWidget {
  const Tarakeem({Key? key}) : super(key: key);

  @override
  State<Tarakeem> createState() => _TarakeemState();
}

class _TarakeemState extends State<Tarakeem> {
  ...
  List<String> spinnerItems = ['احادیث مبارکہ کو چار طریقوں سے', 'طریقوں سےاحادیث مبارکہ', 'احادیث مبارکہ کو', 'احادیث مبارکہ کو چار', 'احادیث مبارکہ کو چار طریقوں'];
