...
import 'package:mohaddis/FrontEnd/SettingScreen.dart';
...
class Tarakeem extends StatefulWidget {
  ...
  final List<TaraqeemSettings>? settings;
  final List<String> list;
  const Tarakeem({Key? key, required this.settings, required this.list}) : super(key: key);
