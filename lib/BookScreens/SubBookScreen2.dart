...
class SubBookScreen2 extends StatefulWidget {
  ...
  final String name;
  const SubBookScreen2({Key? key, required this.name}) : super(key: key);
                            ...
                            child: Container(
                              ...
                              child: ListTile(
                                ...
                                onTap: () async{
                                  ...
                                  prefs.setString('subbook2', "${posobj.data![index].name.toString()}");
                                  setState(() {
                                    Navigator.push(context,
                                        MaterialPageRoute(builder: (_) => SubBookScreen3(name: '${posobj.data![index].name.toString()}')));
                                  });
                                },
                              ),
                            ),
